...
class Pipe:
    ...
    def collide(self, bird):
        ...
        b_point = bird_mask.overlap(bottom_mask, bottom_offset) # if dont collide then we get None
        t_point = bird_mask.overlap(top_mask, top_offset) # if dont collide then we get None
...
def welcome(highscore):
    ...
    while True:
        clock.tick(30)
        draw_window(win,bird,pipes,base,highscore)
